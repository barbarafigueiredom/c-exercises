...
**Saida**
Uma destas palavras: POSITIVE, NEGATIVE, ZERO.
...
```bash
gcc -Wall -Wextra -std=c11 ./exercises/11_sign_of_number/main.c -o ./exercises/11_sign_of_number/program && ./exercises/11_sign_of_number/program --test
```
