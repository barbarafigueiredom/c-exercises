...
**Entrada**
Tres inteiros separados por espacos.
...
```bash
gcc -Wall -Wextra -std=c11 ./exercises/13_greatest_of_three/main.c -o ./exercises/13_greatest_of_three/program && ./exercises/13_greatest_of_three/program --test
```
