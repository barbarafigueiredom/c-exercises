...
```bash
gcc -Wall -Wextra -std=c11 ./exercises/20_remainder_of_division/main.c -o ./exercises/20_remainder_of_division/program && ./exercises/20_remainder_of_division/program --test
```
