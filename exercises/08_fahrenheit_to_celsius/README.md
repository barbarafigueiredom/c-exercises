...
```bash
gcc -Wall -Wextra -std=c11 ./exercises/08_fahrenheit_to_celsius/main.c -o ./exercises/08_fahrenheit_to_celsius/program && ./exercises/08_fahrenheit_to_celsius/program --test
```
